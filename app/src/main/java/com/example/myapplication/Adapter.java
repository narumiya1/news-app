...
public class Adapter extends RecyclerView.Adapter<Adapter.MyViewHolders> {
    ...
    @Override
    public void onBindViewHolder(@NonNull final MyViewHolders holders, int position) {
        final MyViewHolders holder = holders;
    ...
    public class MyViewHolders extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public MyViewHolders(@NonNull View itemView , OnItemClickListener onItemClickListener) {
            super(itemView);
